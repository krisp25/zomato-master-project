    ...
    return (
        <>
            <div className="my-3 flex flex-col gap-3 items-center">
                <h1 className="text-lg text-center md:text-2xl font-bold">Checkout</h1>
                <div className="w-full md:w-3/5 rounded-lg  py-3 md:shadow-lg bg-white flex flex-col items-center">
                    <h3 className="text-base md:text-lg font-semibold">Summary</h3>
                    <div className="flex w-full  flex-col gap-2 items-center">
                        <h5 className="text-sm md:text-base tracking-wider">ORDER FROM</h5>
                        ...
                        <div className="flex flex-col gap-3 w-full md:w-3/5 ">
                            <h4 className="text-lg md:text-xl font-semibold">Choose Address</h4>
                            <AddressList address={address} />
                        </div>
                    </div>
                    <button 
                        onClick={payNow}
                        className="flex items-center gap-2 justify-center my-4 md:my-8 w-full px-4 md:w-4/5 px-0 h-14 text-white font-medium text-base md:text-lg bg-zomato-400 rounded-lg"
                    >
